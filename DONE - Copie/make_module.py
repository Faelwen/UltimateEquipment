...
library_entries =   [{"Entry name":"Legal Notice",
                    ...
                    "Link type":"librarylink",
                    "Window class":"reference_armortablelist",
                    "Record name": "lists.ArmorSpecific@"+module_name},
                    {"Entry name":"Gear - Adventuring Gear",
                    "Entry tag":"CA.AdventuringGear",
                    "Link type":"librarylink",
...
def populate_weapons(xml_lists, xml_reference):
    xml_ref_weapons = etree.SubElement(xml_reference,"Weapons")
    ...
    with open(weapons_file, 'r',encoding="utf-8") as file:
        ...
        for row in csvreader:
            ...
            xml_weapon_link_recordname.text = "reference.Weapons." + weapon_ref + "@" + module_name
            ...
            xml_ref_weapon_reftag = etree.SubElement(xml_ref_weapons, weapon_ref)
...
def populate_specific_weapons(xml_lists, xml_reference):
    xml_ref_weapons = etree.SubElement(xml_reference,"SpecificMagicWeapons")
    ...
    with open(specific_weapons_file, 'r',encoding="utf-8") as file:
        ...
        for row in csvreader:
            ...
            xml_weapon_link_recordname = etree.SubElement(xml_weapon_link, "recordname")
            xml_weapon_link_recordname.text = weapon_name
            xml_weapon_link_recordname.text = "reference.SpecificMagicWeapons." + weapon_ref + "@" + module_name
            xml_weapon_name = etree.SubElement(xml_weapon, "name", type="string")
            xml_weapon_name.text = weapon_name
            xml_weapon_cost = etree.SubElement(xml_weapon, "cost", type="string")
            xml_weapon_cost.text = weapon_cost if weapon_cost != "" else "-"
...
def populate_armor(xml_lists, xml_reference):
    xml_ref_armors = etree.SubElement(xml_reference,"Armor")
    ...
    with open(armor_file, 'r',encoding="utf-8") as file:
        ...
        for row in csvreader:
            ...
            xml_ref_armor_ref = etree.SubElement(xml_ref_armors, armor_ref)
...
def populate_adventuring_gear(xml_lists, xml_reference):
    xml_ref_gear = etree.SubElement(xml_reference,"AdventuringGear")
    ...
    with open(adventure_gear_file, 'r',encoding="utf-8") as file:
        ...
        for row in csvreader:
            ...
            xml_list_gear_sec_eq_ref_link_recname.text = "reference.AdventuringGear." + item_ref + "@" + module_name
            ...
            xml_ref_gear_ref = etree.SubElement(xml_ref_gear, item_ref)
...
def main():
    ...
    #populate_weapons(xml_lists, xml_reference)
    #populate_specific_weapons(xml_lists, xml_reference)
    #populate_armor(xml_lists, xml_reference)
    populate_specific_armor(xml_lists, xml_reference)
    #populate_adventuring_gear(xml_lists, xml_reference)
