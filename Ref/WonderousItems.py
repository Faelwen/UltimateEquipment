...
htmlfiles = ("Belts Slot.html", "Body Slot.html", "Chest Slot.html",
             "Eyes Slot.html", "Feet Slot.html", "Hands Slot.html", "Head Slot.html",
             "Headband Slot.html", "Neck Slot.html", "Shoulders Slot.html", "Slotless.html",
             "Rings.html", "Rods.html", "Staves.html", "Wrists Slot.html")
...
for htmlfile in htmlfiles:
    ...
    for element in all_elements:
        ...
        extract_info = re.search(
            'Price\s?(.*?);\sAura\s?(.*?);\sCL\s?([0-9]*?)[a-z]*; Weight\s?(.*?)\slb', details)
        if extract_info != None:
            ...
            if details.find('Weight —') > 0 or details.find('Weight  —') or details.find('Weight—') > 0 > 0:
